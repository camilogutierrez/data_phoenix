...
#############
  ...
  dimension_group: fecha_de_recepcion {
    ...
    sql: ${TABLE}.Fecha_de_recepcion ;;
    datatype: timestamp
    view_label: "Autoridades Publicas"
    group_label: "Fecha de Recepcion"
    label: "Recepcion"
  }

  dimension_group: fecha_unica_de_vencimiento {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: ${TABLE}.fecha_unica_de_vencimiento ;;
    datatype: timestamp
    view_label: "Autoridades Publicas"
    group_label: "Fecha Unica de Vencimiento"
    label: "Vencimiento"
  }
  ...
  dimension: claim_motivo {
    ...
    view_label: "Autoridades Publicas"
    label: "Reclamo Motivo"
  }

  dimension: claim_sub_motivo {
    type: string
    sql: ${TABLE}.ClaimSubmotivo ;;
    view_label: "Autoridades Publicas"
  ...
  dimension: motivo_de_no_desistimiento {
    type: string
    sql: ${TABLE}.Motivo_de_no_desistimiento ;;
    view_label: "Autoridades Publicas"
    label: "Motivo de no Desistimiento"
  }

  dimension: numero_de_expediente {
    type: string
    sql: ${TABLE}.Numero_de_expediente ;;
    view_label: "Autoridades Publicas"
  ...
  dimension: localidad_reclamo_defensa {
    type: string
    sql: ${TABLE}.Localidad_Reclamo_Defensa ;;
    view_label: "Autoridades Publicas"
    label: "Localidad Reclamo Defensa"
  }

  dimension: localidad_reclamo_enacom {
    type: string
    sql: ${TABLE}.Localidad_Reclamo_Enacom ;;
    view_label: "Autoridades Publicas"
    label: "Localidad Reclamo Enacom"
  }

  dimension: organismo_defensa_consumidor {
    type: string
    sql: ${TABLE}.Organismo_Defensa_Consumidor ;;
    view_label: "Autoridades Publicas"
    label: "Organismo Defensa Consumidor"
  }

  dimension: provincia_reclamo {
    type: string
    sql: ${TABLE}.Provincia_Reclamo ;;
    view_label: "Autoridades Publicas"
    label: "Provincia Reclamo"
  }

  dimension: motivo_no_desistible {
    type: string
    sql: ${TABLE}.Motivo_no_Desistible ;;
    view_label: "Autoridades Publicas"
  ...
  dimension: motivo_de_respuesta {
    ...
    view_label: "Autoridades Publicas"
    label: "Motivo de Respuesta"
  }

  dimension: motivo_de_respuesta_enacom {
    type: string
    sql: ${TABLE}.Motivo_de_respuesta_ENACOM ;;
    view_label: "Autoridades Publicas"
    label: "Motivo de Respuesta ENACOM"
  }
...
## Measures
  ...
  measure: total_importe_aplicado {
    type: sum
    sql: ${importe_aplicado} ;;
    view_label: "Autoridades Publicas"
    label: "Total Importe Aplicado"
  }
